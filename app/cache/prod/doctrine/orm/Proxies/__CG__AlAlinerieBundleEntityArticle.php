...
namespace Proxies\__CG__\Al\AlinerieBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Article extends \Al\AlinerieBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Al\\AlinerieBundle\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'Al\\AlinerieBundle\\Entity\\Article' . "\0" . 'date', '' . "\0" . 'Al\\AlinerieBundle\\Entity\\Article' . "\0" . 'title', '' . "\0" . 'Al\\AlinerieBundle\\Entity\\Article' . "\0" . 'author', '' . "\0" . 'Al\\AlinerieBundle\\Entity\\Article' . "\0" . 'content', '' . "\0" . 'Al\\AlinerieBundle\\Entity\\Article' . "\0" . 'published', '' . "\0" . 'Al\\AlinerieBundle\\Entity\\Article' . "\0" . 'image', '' . "\0" . 'Al\\AlinerieBundle\\Entity\\Article' . "\0" . 'categorie', '' . "\0" . 'Al\\AlinerieBundle\\Entity\\Article' . "\0" . 'updatedAt');
        }
