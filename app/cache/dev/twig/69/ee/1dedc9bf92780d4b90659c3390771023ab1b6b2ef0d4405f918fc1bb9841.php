...
\t\t\t<div class=\"carreCateg\" style=\"background-image:url('images/carre";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["categorie"]) ? $context["categorie"] : $this->getContext($context, "categorie")), "slug", array()), "html", null, true);
        echo "\"/><h3><span class=\"bold\">";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["categorie"]) ? $context["categorie"] : $this->getContext($context, "categorie")), "bold", array()), "html", null, true);
        echo "</span>";
        if ((($this->getAttribute((isset($context["categorie"]) ? $context["categorie"] : $this->getContext($context, "categorie")), "slug", array()) == "geekerie") || ($this->getAttribute((isset($context["categorie"]) ? $context["categorie"] : $this->getContext($context, "categorie")), "slug", array()) == "bypasserie"))) {
            echo "ERIE.";
        } else {
            echo "RIE.";
        }
...
\t\t\t<div class=\"titreCateg titreCateg";
            // line 17
            echo twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, $this->getAttribute((isset($context["categorie"]) ? $context["categorie"] : $this->getContext($context, "categorie")), "slug", array())), "html", null, true);
            echo " float\"><a href=\"";
