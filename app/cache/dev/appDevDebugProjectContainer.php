...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/AlSymfonyAlinerie/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/AlSymfonyAlinerie/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfonyAlinerie', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_50b1a3042477920a2f3956ba7fff059014a931525016f167af70e27a3bd06e52');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_50b1a3042477920a2f3956ba7fff059014a931525016f167af70e27a3bd06e52');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_50b1a3042477920a2f3956ba7fff059014a931525016f167af70e27a3bd06e52');
        ...
        $g->setProxyDir('C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/AlSymfonyAlinerie/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/AlSymfonyAlinerie/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/AlSymfonyAlinerie/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/AlSymfonyAlinerie/app', 'UTF-8');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/translations', 'debug' => true));
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\AlSymfonyAlinerie\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.bg.yml', 'bg', 'messages');
        $instance->addResource('yml', 'C:\\wamp\\www\\AlSymfonyAlinerie\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.de.yml', 'de', 'messages');
        $instance->addResource('yml', 'C:\\wamp\\www\\AlSymfonyAlinerie\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.en.yml', 'en', 'messages');
        $instance->addResource('yml', 'C:\\wamp\\www\\AlSymfonyAlinerie\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.fr.yml', 'fr', 'messages');
        $instance->addResource('yml', 'C:\\wamp\\www\\AlSymfonyAlinerie\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.it.yml', 'it', 'messages');
        $instance->addResource('yml', 'C:\\wamp\\www\\AlSymfonyAlinerie\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.pl.yml', 'pl', 'messages');
        $instance->addResource('yml', 'C:\\wamp\\www\\AlSymfonyAlinerie\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/translations\\messages.ru.yml', 'ru', 'messages');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\AlSymfonyAlinerie\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\wamp\\www\\AlSymfonyAlinerie\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:\\wamp\\www\\AlSymfonyAlinerie\\vendor\\coresphere\\console-bundle\\CoreSphere\\ConsoleBundle/Resources/views', 'CoreSphereConsole');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/AlSymfonyAlinerie/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev',
            ...
            'debug.container.dump' => 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/AlSymfonyAlinerie/app/../web',
            'assetic.write_to' => 'C:/wamp/www/AlSymfonyAlinerie/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/AlSymfonyAlinerie/app/cache/dev/doctrine/orm/Proxies',
